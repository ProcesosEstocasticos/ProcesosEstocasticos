...
program rw
  ...
  integer jt, N, L
  real(8) t !voy a incrementar el tiemo en 1/nw
  integer pos,sel,nw
  integer:: rea,nrea
  real(8) rho
  ...
  call tiempo(tmax) !tiempo equiespaciado pot 10

  allocate(position(L),rho_t(0:tptos))
  rho_t=0d0 !inicializo la variable
